%\VignetteIndexEntry{NarrowPeaks Vignette II. Inter-sample variability: Analysis of variation in differential binding across ChIP-seq samples.}
...
\title{narrowpeaksDiff: Analysis of differential variation across ChIP-seq experiments}
\date{January, 2013}
